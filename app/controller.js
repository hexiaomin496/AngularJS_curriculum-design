...
function mainctrl ($scope){
	$scope.userArr=[
			{'userName':"何小敏",'tag':'IT小透明','userAddress':'海外，列支敦士登','userImg':'images/a7.jpg','fansNum':250},
			...
			{'userName':'我是花子','userImg':'images/a1.jpg','content':'这世界上的很多事，有时候和我们眼睛看到的不一样。很多时候要我们慢慢地体会才会知道。我们不能急着看结果，就像种下一棵小花，你要耐心地等它破土发芽，慢慢长大，才能看到它开出美丽的花。尘世间的事也一样，要在时间里发酵，岁月里沉香，人生那些百思不得其解的事情，到后来时间会一一给你答案。岁月有时候特别用心良苦，它时常会给你很多磨难，其实它是想让你变得更好。'},
	...
	$scope.comments=[
			...
			{commTarget:'我是花子',userImg:"images/a8.jpg",userName:"尚睿睿",userComment:'好的哦',time:''}
	];
	$scope.addComment=function(){
		var comArr=[];
		comArr.userImg="images/a5.jpg";
		comArr.commTarget="我是花子";
		comArr.userName="尚睿睿";
	...
	$scope.setFuc=function()
	{
		...
		$scope.userArr[0].userName=username;
		//头像地址修改
		var displaysrc=document.getElementById("displaysrc").value;
		if(displaysrc=="")
		{
			$scope.userArr[0].userImg="images/a7.jpg";
		}
		else
		{
			$scope.userArr[0].userImg="images/"+displaysrc.substr(12);
		}	
	}
